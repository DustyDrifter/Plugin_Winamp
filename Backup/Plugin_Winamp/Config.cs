...
namespace Plugin_Winamp
{
    public partial class Config : Form
    {
        ...
        {
            this.Text = Var.MyHost.Lang(Var.PluginFileName, "Config");
            this.groupBox1.Text = Var.MyHost.Lang(Var.PluginFileName, "groupBox1");
            this.button1.Text = Var.MyHost.Lang(Var.PluginFileName, "button1");
            this.groupBox2.Text = Var.MyHost.Lang(Var.PluginFileName, "groupBox2");
            this.label1.Text = Var.MyHost.Lang(Var.PluginFileName, "label1");
            this.button4.Text = Var.MyHost.Lang(Var.PluginFileName, "button4");
            this.button5.Text = Var.MyHost.Lang(Var.PluginFileName, "button5");
            this.button3.Text = Var.MyHost.Lang(Var.PluginFileName, "button3");
            this.button2.Text = Var.MyHost.Lang(Var.PluginFileName, "button2");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            folderBrowserDialog.Description = "Dossier des plug-ins Winamp";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (Class1.pluginhandle == 0)
            {
                try
                {
                    ...
                    if (Class1.pluginhandle != 0)
                    {
                        BassWaDsp.BASS_WADSP_Start(Class1.pluginhandle, Var.selectedModule, Var.MyHost.MainMixerHandle);
                        Class1.dsphandle = BassWaDsp.BASS_WADSP_ChannelSetDSP(Class1.pluginhandle, Var.MyHost.MainMixerHandle, 10);
                ...
                {
                    MessageBox.Show("Oups ! Une erreur est survenue lors du chargement du plugin.");
                }
            }
        }
